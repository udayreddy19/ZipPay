...
export interface Spec extends TurboModule {
    ...
    createEmbeddedPaymentElementWithCheckout(sessionKey: string, configuration: UnsafeObject<EmbeddedPaymentElementConfiguration>): Promise<void>;
    confirmEmbeddedPaymentElement(viewTag: Int32): Promise<EmbeddedPaymentElementResult>;
    updateEmbeddedPaymentElement(intentConfig: UnsafeObject<IntentConfiguration>): Promise<UnsafeObject<any> | null>;
    updateEmbeddedPaymentElementWithCheckout(sessionKey: string): Promise<UnsafeObject<any> | null>;
    ...
    checkoutRunServerUpdateStart(sessionKey: string): Promise<UnsafeObject<Checkout.State>>;
    checkoutRunServerUpdateComplete(sessionKey: string, error: string | null): Promise<void>;
