 ...
 * @internal
 */
export declare function CurrencySelectorElement({ checkout, disabled, ...a11yProps }: CurrencySelectorElementProps): React.JSX.Element;
//# sourceMappingURL=CurrencySelectorElement.d.ts.map